...
let image4 = document.getElementById('project-4-image');

// Project descriptions
let text1 = document.querySelector('.project-text-container-1');
let text2 = document.querySelector('.project-text-container-2');
let text3 = document.querySelector('.project-text-container-3');
let text4 = document.querySelector('.project-text-container-4');
...
let githubProject4 = document.querySelector('.project-4 #github');
...
// Links to project 4's website
let linkProject4 = document.querySelector('.project-4-link-text');
...
if (window.matchMedia("(orientation: landscape)").matches) {
    ...
    if (window.matchMedia("(max-width: 700px)").matches) {
        ...
        githubProject4.addEventListener('click', (event) => {
            githubProject4.style.cssText = 'width: 5vw; height: 5vw; transition: .5s';
        });
        ...
        // Text link to project 4's website
        linkProject4.addEventListener('click', (event) => {
            linkProject4.style.cssText = 'font-size: 4.3vw; font-weight: bold; color: rgba(135, 206, 250, 0.733); text-shadow: none; transition: .5s';
        });
        ...
        githubProject4.addEventListener('mouseover', (event) => {
            githubProject4.style.cssText = 'width: 5.5vw; height: 5.5vw; transition: .5s';
        });
        ...
        linkProject4.addEventListener('mouseover', (event) => {
            linkProject4.style.cssText = 'font-size: 4.8vw; color: rgba(135, 206, 250, 0.733); text-shadow: black 0.2rem 0.2rem 0.2rem; transition: .5s';
        });
        ...
        githubProject4.addEventListener('mouseout', (event) => {
            githubProject4.style.cssText = 'width: 5vw; height: 5vw; transition: .5s';
        });
        ...
        linkProject4.addEventListener('mouseout', (event) => {
            linkProject4.style.cssText = 'font-size: 4.3vw; font-weight: bold; color: rgba(135, 206, 250, 0.733); text-shadow: none; transition: .5s';
        });
    /* Sizes specified are for screens in landscape orientation with a width greater than 700px */
    } else {
        ...
        githubProject4.addEventListener('click', (event) => {
            githubProject4.style.cssText = 'width: 2.5vw; height: 2.5vw; transition: .5s';
        });
        linkProject1.addEventListener('click', (event) => {
        ...
        linkProject4.addEventListener('click', (event) => {
            linkProject4.style.cssText = 'font-size: 2vw; font-weight: bold; color: rgba(135, 206, 250, 0.733); text-shadow: none; transition: .5s';
        });
        ...
        githubProject4.addEventListener('mouseover', (event) => {
            githubProject4.style.cssText = 'width: 3vw; height: 3vw; transition: .5s';
        });
        linkProject1.addEventListener('mouseover', (event) => {
        ...
        linkProject4.addEventListener('mouseover', (event) => {
            linkProject4.style.cssText = 'font-size: 2.5vw; color: rgba(135, 206, 250, 0.733); text-shadow: black 0.2rem 0.2rem 0.2rem; transition: .5s';
        });
...
if (window.matchMedia("(orientation: landscape)").matches) {
    ...
    // When the mouse hovers over the project 3 image, change its style & display information about it
    project3.addEventListener('mouseover', (event) => {
        project3.style.cssText = 'border: 0.19rem solid rgb(61, 102, 102); border-radius: 0.5rem;';
        image3.style.cssText = 'filter: blur(1vh) brightness(90%)';
        text3.style.cssText = 'visibility: visible; opacity: 1; transition: opacity 1.5s linear;';
    });
    // When the mouse does not hover over the project 3 image anymore, set it back to its original look
    project3.addEventListener('mouseout', (event) => {
        project3.style.cssText = 'border: 0.19rem solid rgb(74, 87, 87);';
        image3.style.cssText = 'filter: blur(0) brightness(100%); transition: 1s';
        text3.style.cssText = 'visibility: hidden; opacity: 0; transition: opacity 0.5s linear;';
    });

    // When the mouse hovers over the project 4 image, change its style & display information about it
    project4.addEventListener('mouseover', (event) => {
        project4.style.cssText = 'border: 0.19rem solid rgb(61, 102, 102); border-radius: 0.5rem;';
        image4.style.cssText = 'filter: blur(1vh) brightness(25%)';
        text4.style.cssText = 'visibility: visible; opacity: 1; transition: opacity 1.5s linear;';
    });
    // When the mouse does not hover over the project 4 image anymore, set it back to its original look
    project4.addEventListener('mouseout', (event) => {
        project4.style.cssText = 'border: 0.19rem solid rgb(74, 87, 87);';
        image4.style.cssText = 'filter: blur(0) brightness(100%); transition: 1s';
        text4.style.cssText = 'visibility: hidden; opacity: 0; transition: opacity 0.5s linear;';
    });
}
...
if (window.matchMedia("(orientation: portrait)").matches) {
    ...
    // When the user clicks on the project 3 image, change its style & display information about it
    project3.addEventListener('click', (event) => {
        project3.style.cssText = 'border: 0.19rem solid rgb(61, 102, 102); border-radius: 0.5rem;';
        image3.style.cssText = 'filter: blur(1vh) brightness(90%)';
        text3.style.cssText = 'visibility: visible; opacity: 1; transition: opacity 1.5s linear;';
    });
    // When the user clicks out of the project 3 image, set it back to its original look
    project3.addEventListener('mouseout', (event) => {
        project3.style.cssText = 'border: 0.19rem solid rgb(74, 87, 87);';
        image3.style.cssText = 'filter: blur(0) brightness(100%); transition: 1s';
        text3.style.cssText = 'visibility: hidden; opacity: 0; transition: opacity 0.5s linear;';
    ...
    // When the user clicks on the project 4 image, change its style & display information about it
    project4.addEventListener('click', (event) => {
        project4.style.cssText = 'border: 0.19rem solid rgb(61, 102, 102); border-radius: 0.5rem;';
        image4.style.cssText = 'filter: blur(1vh) brightness(25%)';
        text4.style.cssText = 'visibility: visible; opacity: 1; transition: opacity 1.5s linear;';
    });
    // When the user clicks out of the project 4 image, set it back to its original look
    project4.addEventListener('mouseout', (event) => {
        project4.style.cssText = 'border: 0.19rem solid rgb(74, 87, 87);';
        image4.style.cssText = 'filter: blur(0) brightness(100%); transition: 1s';
        text4.style.cssText = 'visibility: hidden; opacity: 0; transition: opacity 0.5s linear;';
